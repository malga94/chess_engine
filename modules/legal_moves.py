...
def check_empty_path(position, x_st, y_st, x_end, y_end):
...
def rook_move(position, st_pos, end_pos, colour):
    ...
    return check_empty_path(position, x_st, y_st, x_end, y_end)

def knight_move(position, st_pos, end_pos, colour):
...
def bishop_move(position, st_pos, end_pos, colour):
...
def queen_move(position, st_pos, end_pos, colour):
...
def king_move(position, st_pos, end_pos, colour):

    return True

def pawn_move(position, st_pos, end_pos, colour):
    ...
    if colour == 0:
        ...
        if position[y_end][x_end][0] == 'w': #The arrival position has a white piece on it
            ...
            if y_st == 6:
                 if x_end != x_st or y_end != y_end - 1 or y_end != y_end - 2:
                     print("That's not how the pawn moves! Try another move")
                     return False

            else:
                 if x_end != x_st or y_end != y_end - 1:
                     print("That's not how the pawn moves! Try another move")
                     return False

        else:
            if abs(x_end - x_st) != 1 or y_end != y_end - 1:
                print("That's not how the pawn moves! Try another move")
                return False
